  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-3">
      <div className="flex items-center gap-2 mb-2">
        <Warehouse className="text-indigo-500 dark:text-indigo-400 h-4 w-4" />
        <h2 className="text-sm font-semibold text-gray-800 dark:text-white">Garage</h2>
      </div>
      ...
      <div className="text-center">
        ...
        <button
          ...
          className={`mt-2 w-full py-1.5 px-3 rounded-lg text-xs font-medium text-white transition-colors ${
        ...
        >
          {loading ? (
            <span className="flex items-center justify-center gap-1">
              <Loader className="h-3 w-3 animate-spin" /> Working...
            </span>
          ) : (
            'Toggle Garage Door'
          )}
